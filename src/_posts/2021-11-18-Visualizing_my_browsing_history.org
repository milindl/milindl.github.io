...
For the graph I have in mind, I need data which looks like this:
...
only if you're Firefox like me. The entire process of getting the data if you're using Chrome will be different (and not documented here).
